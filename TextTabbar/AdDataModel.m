...
- (instancetype)initWithImageName
{
    ...
    if (self)
    {
        _imageNameArray =  [NSArray arrayWithObjects:@"image0.png",@"image1.png",@"image2.png",@"image3.png",nil];
    }
    return self;
}
...
{
    _adTitleArray = [NSArray arrayWithObjects:@"image0.png",@"image1.png",@"image2.png",@"image3.png",nil];
